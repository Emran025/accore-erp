...
class ModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            ['module_key' => 'investments', 'module_name_ar' => 'الأصول الاستثمارية', 'module_name_en' => 'Investments', 'category' => 'finance', 'icon' => 'briefcase', 'sort_order' => 57],
            ['module_key' => 'currency', 'module_name_ar' => 'العملات والسياسة النقدية', 'module_name_en' => 'Currency & Finance Policy', 'category' => 'finance', 'icon' => 'coins', 'sort_order' => 58],
            ['module_key' => 'monetary_policy', 'module_name_ar' => 'السياسات النقدية', 'module_name_en' => 'Monetary Policy', 'category' => 'finance', 'icon' => 'shield', 'sort_order' => 59],
            ['module_key' => 'exchange_rate', 'module_name_ar' => 'أسعار الصرف', 'module_name_en' => 'Exchange Rates', 'category' => 'finance', 'icon' => 'trending-up', 'sort_order' => 60],
            ['module_key' => 'currency_transfer', 'module_name_ar' => 'عمليات الصرف الأجنبي', 'module_name_en' => 'FX Operations', 'category' => 'finance', 'icon' => 'refresh', 'sort_order' => 61],
            ['module_key' => 'currency_history', 'module_name_ar' => 'سجل العملات', 'module_name_en' => 'Currency History', 'category' => 'finance', 'icon' => 'history', 'sort_order' => 62],
            ['module_key' => 'currency_balances', 'module_name_ar' => 'مراكز العملات', 'module_name_en' => 'Currency Balances', 'category' => 'finance', 'icon' => 'scale', 'sort_order' => 63],
            ['module_key' => 'vat_zatca', 'module_name_ar' => 'الضرائب والزكاة (VAT/ZATCA)', 'module_name_en' => 'VAT & ZATCA Management', 'category' => 'finance', 'icon' => 'shield-check', 'sort_order' => 64],
            ['module_key' => 'reports', 'module_name_ar' => 'الميزانية والتقارير', 'module_name_en' => 'Reports & Balance Sheet', 'category' => 'reports', 'icon' => 'eye', 'sort_order' => 65],
            ['module_key' => 'audit_trail', 'module_name_ar' => 'سجل التدقيق', 'module_name_en' => 'Audit Trail', 'category' => 'system', 'icon' => 'eye', 'sort_order' => 70],
            ['module_key' => 'notifications', 'module_name_ar' => 'الإشعارات', 'module_name_en' => 'Notifications', 'category' => 'system', 'icon' => 'bell', 'sort_order' => 71],
            ['module_key' => 'system_logs', 'module_name_ar' => 'سجلات النظام', 'module_name_en' => 'System Logs', 'category' => 'system', 'icon' => 'file-search', 'sort_order' => 72],
            ['module_key' => 'recurring_transactions', 'module_name_ar' => 'المعاملات المتكررة', 'module_name_en' => 'Recurring Transactions', 'category' => 'system', 'icon' => 'check', 'sort_order' => 73],
            ['module_key' => 'batch_processing', 'module_name_ar' => 'المعالجة الدفعية', 'module_name_en' => 'Batch Processing', 'category' => 'system', 'icon' => 'check', 'sort_order' => 74],
            ['module_key' => 'users', 'module_name_ar' => 'إدارة المستخدمين', 'module_name_en' => 'User Management', 'category' => 'system', 'icon' => 'users', 'sort_order' => 75],
            ['module_key' => 'settings', 'module_name_ar' => 'الإعدادات', 'module_name_en' => 'Settings', 'category' => 'system', 'icon' => 'settings', 'sort_order' => 76],
            ['module_key' => 'system_templates', 'module_name_ar' => 'إدارة القوالب', 'module_name_en' => 'Template Management', 'category' => 'system', 'icon' => 'file-signature', 'sort_order' => 77],
            ['module_key' => 'roles_permissions', 'module_name_ar' => 'الأدوار والصلاحيات', 'module_name_en' => 'Roles & Permissions', 'category' => 'system', 'icon' => 'lock', 'sort_order' => 78],
            ['module_key' => 'intelligence', 'module_name_ar' => 'ذكاء الأعمال', 'module_name_en' => 'Business Intelligence', 'category' => 'intelligence', 'icon' => 'pie-chart', 'sort_order' => 90],
            ['module_key' => 'projects', 'module_name_ar' => 'إدارة المشاريع', 'module_name_en' => 'Projects', 'category' => 'projects', 'icon' => 'briefcase', 'sort_order' => 100],
            ['module_key' => 'manufacturing', 'module_name_ar' => 'التصنيع', 'module_name_en' => 'Manufacturing', 'category' => 'manufacturing', 'icon' => 'factory', 'sort_order' => 110],
            ['module_key' => 'platform', 'module_name_ar' => 'المنصة والمطورين', 'module_name_en' => 'Platform', 'category' => 'platform', 'icon' => 'code', 'sort_order' => 120],
            ['module_key' => 'hr', 'module_name_ar' => 'الموارد البشرية', 'module_name_en' => 'Human Resources', 'category' => 'hr', 'icon' => 'users', 'sort_order' => 130],
            ['module_key' => 'employees', 'module_name_ar' => 'إدارة الموظفين', 'module_name_en' => 'Employee Management', 'category' => 'hr', 'icon' => 'user-tie', 'sort_order' => 131],
