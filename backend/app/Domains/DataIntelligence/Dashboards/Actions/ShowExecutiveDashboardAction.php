...
namespace App\Domains\DataIntelligence\Dashboards\Actions;
...
class ShowExecutiveDashboardAction extends Action
{
    ...
    public function __invoke(): JsonResponse
    {
        ...
        $pendingRequests = \App\Domains\Commercial\Purchases\Models\PurchaseRequest::where('status', 'pending')
            ->with(['product', 'user'])
            ->orderBy('created_at', 'desc')
            ->limit(10)
            ->get();
