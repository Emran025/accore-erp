...
namespace App\Domains\Finance\TaxCompliance\Services;
...
class TaxCalculator
{
    ...
    public function calculate(
        ...
        if ($taxableId && $taxableType && !empty($result->lines)) {
            // $taxableType can be class name (App\Domains\Commercial\SalesLifecycle\Models\Invoice) or table name (invoices)
