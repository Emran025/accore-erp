...
namespace App\Domains\HumanCapital\PayrollBenefits\Services;
...
class SalaryCalculatorService implements SalaryCalculatorInterface
{
    ...
    protected function getBaseSalary(Employee $employee, string $periodStart)
    {
        ...
        $contract = \App\Domains\HumanCapital\WorkforceAdmin\Models\EmployeeContract::where('employee_id', $employee->id)
