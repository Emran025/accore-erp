...
namespace App\Domains\HumanCapital\HRAdvanced\Services;

use App\Domains\EnterpriseCore\OrganizationGovernance\Models\DocumentTemplate;
use App\Domains\EnterpriseCore\OrganizationGovernance\Models\DocumentTemplateHistory;
...
class TemplateRenderer
{
    ...
    protected function prepareReplacements(array $context, string $templateType): array
    {
        ...
        try {
            $settings = \App\Domains\EnterpriseCore\OrganizationGovernance\Models\Setting::first();
            if ($settings) {
