...
namespace App\Http\Controllers\Api\V2\HumanCapital\DocumentManagement;

use App\Http\Controllers\Controller;
use App\Domains\HumanCapital\DocumentManagement\Services\TemplateRegistry;
use App\Http\Requests\HumanCapital\DocumentManagement\StoreDocumentTemplateRequest;
use App\Http\Requests\HumanCapital\DocumentManagement\UpdateDocumentTemplateRequest;
use App\Http\Requests\HumanCapital\DocumentManagement\RenderDocumentTemplateRequest;
use App\Http\Requests\HumanCapital\DocumentManagement\ListDocumentTemplatesRequest;
use App\Domains\HumanCapital\DocumentManagement\Actions\CreateHrDocumentTemplateAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\DeleteHrDocumentTemplateAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\GetHrDocumentTemplateApprovedKeysAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\ListHrDocumentTemplatesAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\RenderHrDocumentTemplateAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\ShowHrDocumentTemplateAction;
use App\Domains\HumanCapital\DocumentManagement\Actions\UpdateHrDocumentTemplateAction;
