...
use App\Http\Controllers\Api\V2\HumanCapital\HRCompliance\QaComplianceController;
use App\Http\Controllers\Api\V2\EnterpriseCore\OrganizationGovernance\EhsController;
use App\Http\Controllers\Api\V2\Finance\ManagementAccounting\TravelExpenseController;
use App\Http\Controllers\Api\V2\HumanCapital\HRCompliance\CorporateCommunicationsController;
use App\Http\Controllers\Api\V2\HumanCapital\HRCompliance\KnowledgeManagementController;
use App\Http\Controllers\Api\V2\HumanCapital\HRAdvanced\DocumentTemplateController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\CompensationController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\EmployeeLoansController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\EOSBController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\PayrollComponentsController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\PayrollController;
use App\Http\Controllers\Api\V2\HumanCapital\PayrollBenefits\PostPayrollController;
use App\Http\Controllers\Api\V2\HumanCapital\TalentRecruitment\OnboardingController;
use App\Http\Controllers\Api\V2\HumanCapital\TalentRecruitment\RecruitmentController;
use App\Http\Controllers\Api\V2\HumanCapital\PerformanceDevelopment\LearningController;
use App\Http\Controllers\Api\V2\HumanCapital\PerformanceDevelopment\PerformanceController;
use App\Http\Controllers\Api\V2\HumanCapital\PerformanceDevelopment\SuccessionController;
use App\Http\Controllers\Api\V2\HumanCapital\TimeProductivity\AttendanceController;
use App\Http\Controllers\Api\V2\HumanCapital\TimeProductivity\BiometricController;
use App\Http\Controllers\Api\V2\HumanCapital\TimeProductivity\LeaveController;
use App\Http\Controllers\Api\V2\HumanCapital\TimeProductivity\WorkforceSchedulingController;
