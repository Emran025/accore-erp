...
use App\Http\Controllers\Api\V2\HumanCapital\{
    ...
    ServicesWellness\ComplianceController,
    ...
    WorkforceAdmin\AssetsController,
...
Route::group(['prefix' => 'v2', 'middleware' => ['api.auth', 'throttle:api']], function () {
    ...
    Route::get('/my-payslips', [PayrollController::class, 'myPayslips'])->name('v2.payroll.my_payslips');
...
Route::group(['prefix' => 'v2', 'middleware' => ['api.auth', 'throttle:api']], function () {
    ...
    // ── QA & Compliance
    Route::middleware('can:employees,view')->group(function () {
        Route::get('/compliance', [ComplianceController::class, 'index'])->name('v2.compliance.index');
        Route::get('/compliance/{id}', [ComplianceController::class, 'show'])->name('v2.compliance.show');
    });
    Route::middleware(['can:employees,create', 'throttle:api-write'])->group(function () {
        Route::post('/compliance', [ComplianceController::class, 'store'])->name('v2.compliance.store');
        Route::post('/compliance/{complianceId}/capa', [ComplianceController::class, 'storeCapa'])->name('v2.compliance.capa.store');
    });
    Route::middleware(['can:employees,edit', 'throttle:api-write'])->put('/compliance/{id}', [ComplianceController::class, 'update'])->name('v2.compliance.update');
...
Route::group(['prefix' => 'v2', 'middleware' => ['api.auth', 'throttle:api']], function () {
    ...
    Route::middleware('can:employees,view')->group(function () {
        Route::get('/employee-assets', [AssetsController::class, 'index'])->name('v2.employee_assets.index');
        Route::get('/employee-assets/{id}', [AssetsController::class, 'show'])->name('v2.employee_assets.show');
    });
    Route::middleware(['can:employees,create', 'throttle:api-write'])->post('/employee-assets', [AssetsController::class, 'store'])->name('v2.employee_assets.store');
    Route::middleware(['can:employees,edit', 'throttle:api-write'])->put('/employee-assets/{id}', [AssetsController::class, 'update'])->name('v2.employee_assets.update');
    Route::middleware(['can:employees,delete', 'throttle:api-delete'])->delete('/employee-assets/{id}', [AssetsController::class, 'destroy'])->name('v2.employee_assets.destroy');
