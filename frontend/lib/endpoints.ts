...
export const API_ENDPOINTS = {
    ...
    FINANCE: {
        ...
        CURRENCIES: {
            BASE: "/treasury/currencies",
            withId: (id: string | number) => `/treasury/currencies/${id}`,
            TOGGLE: (id: string | number) => `/treasury/currencies/${id}/toggle-active`,
        },
        CURRENCY_POLICIES: {
            BASE: "/treasury/policies",
            ACTIVE: "/treasury/policies/active",
            TYPES: "/treasury/policies/types",
            withId: (id: string | number) => `/treasury/policies/${id}`,
            ACTIVATE: (id: string | number) => `/treasury/policies/${id}/activate`,
        },
        TREASURY: {
            EXCHANGE_RATE: "/treasury/rates/exchange",
            RATES_HISTORY: "/treasury/rates/history",
            RECORD_RATE: "/treasury/rates/record",
            CONVERT: "/treasury/convert",
            REVALUATION: "/treasury/revaluation",
            CURRENCY_POSITIONS: "/treasury/currency-positions",
        },
        EXPENSES: "/expenses",
        ASSETS: "/assets",
        REVENUES: "/revenues",
