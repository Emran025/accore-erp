...
export const PLATFORM: PlatformEndpoints = {
    NUMBER_RANGES: {
        OBJECTS: {
            BASE: "/v2/number-ranges/objects",
            SUMMARY: "/v2/number-ranges/objects/summary",
            withId: (id: string | number) => `/v2/number-ranges/objects/${id}`,
            byType: (type: string) => `/v2/number-ranges/objects/type/${type}`,
        },
        GROUPS: {
            list: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/groups`,
            create: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/groups`,
            update: (groupId: string | number) => `/v2/number-ranges/groups/${groupId}`,
            delete: (groupId: string | number) => `/v2/number-ranges/groups/${groupId}`,
        },
        INTERVALS: {
            list: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/intervals`,
            create: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/intervals`,
        ...
        ASSIGNMENTS: {
            list: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/assignments`,
            create: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/assignments`,
            delete: (assignmentId: string | number) => `/v2/number-ranges/assignments/${assignmentId}`,
        },
        FULLNESS: (objectId: string | number) => `/v2/number-ranges/objects/${objectId}/fullness`,
