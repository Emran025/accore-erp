...
export default function AddIntervalPage() {
    ...
    const { objectData, isLoading, createObject, saveInterval } = useNumberRange({ objectType: "ap_suppliers" });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (ok) {
            router.push("/ap_suppliers/groups-number-range-interval/ap_suppliers/view-number-range-intervals");
        }
    };
            ...
            <div className="sales-card compact">
                ...
                <form onSubmit={handleSubmit} style={{ maxWidth: "600px", marginTop: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem" }}>
                        ...
                        <Button variant="secondary" type="button" onClick={() => router.push("/ap_suppliers/groups-number-range-interval/ap_suppliers/view-number-range-intervals")}>
                            إلغاء
                        </Button>
                    </div>
                </form>
