...
export default function ViewNumberRangeIntervalsPage() {
    ...
    const { objectData, isLoading, createObject, saveInterval, deleteInterval, expandInterval } = useNumberRange({ objectType: "ar_customers" });
        ...
        return (
            <MainLayout>
                <div className="page-header">
                    <h2>عرض نطاقات أرقام العملاء</h2>
                </div>
        ...
        <MainLayout>
            ...
            <div className="sales-card compact">
                <PageSubHeader
                    ...
                    titleIcon="hash"
                    actions={
                        <Button variant="primary" icon="plus" onClick={() => router.push("/02-commercial/crm/customer-groups-nr/add-customer-nr")}>
                            إضافة نطاق جديد
                        </Button>
                    }
                />
