...
export default function AddCustomersGroupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (ok) {
            router.push("/02-commercial/crm/customer-groups-nr/view-customer-groups");
        }
    };
            ...
            <div className="sales-card compact">
                ...
                <form onSubmit={handleSubmit} style={{ maxWidth: "600px", marginTop: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem" }}>
                        ...
                        <Button variant="secondary" type="button" onClick={() => router.push("/02-commercial/crm/customer-groups-nr/view-customer-groups")}>
                            إلغاء
                        </Button>
                    </div>
                </form>
