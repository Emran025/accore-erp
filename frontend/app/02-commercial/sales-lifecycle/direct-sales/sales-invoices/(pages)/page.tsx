...
import { Column, ConfirmDialog, Dialog, InvoiceTableColumn, Label, NumberInput, ReturnData, SalesReturnDialog, SearchableSelect, SegmentedToggle, SelectOption, SelectableInvoice, SelectableInvoiceTable, SelectedItem, Table, SelectableInvoiceItem as UiInvoiceItem, showAlert, showToast } from "@/components/ui";
...
export default function SalesPage() {
    ...
    const loadInvoices = useCallback(async (page: number = 1) => {
        try {
            setIsLoading(true);
            const response = await fetchAPI(`${API_ENDPOINTS.COMMERCIAL.SALES.INVOICES}?page=${page}&limit=${itemsPerPage}`);
