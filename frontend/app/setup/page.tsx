  ...
  return (
    <div className="settings-wrapper setup-workflow">
      <SetupReadinessSummary
        ...
        foundationLabel={locale === "ar-SA" ? "الأساس التنظيمي" : "Organization foundation"}
        templateLabel={locale === "ar-SA" ? "القالب التنظيمي" : "Organization template"}
      ...
      {journeyStep === "foundation" ? <>
        ...
        {templateApplied ? <p className="readiness-notice success">
          {locale === "ar-SA"
            ? "تم إنشاء الأساس التنظيمي للقالب. استخدم المصمم المتقدم لاحقًا لإضافة فروع أو قنوات أو فرق أو هياكل تخصصية."
            : "The template foundation is ready. Use the advanced designer later for branches, channels, teams, and specialized structures."}
        </p> : null}
