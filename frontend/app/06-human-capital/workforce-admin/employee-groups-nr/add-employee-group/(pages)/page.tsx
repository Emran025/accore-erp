...
export default function AddEmployeesGroupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (ok) {
            router.push("/06-human-capital/workforce-admin/employee-groups-nr/view-employee-groups");
        }
    };
            ...
            <div className="sales-card compact">
                ...
                <form onSubmit={handleSubmit} style={{ maxWidth: "600px", marginTop: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem" }}>
                        ...
                        <Button variant="secondary" type="button" onClick={() => router.push("/06-human-capital/workforce-admin/employee-groups-nr/view-employee-groups")}>
                            إلغاء
                        </Button>
                    </div>
                </form>
