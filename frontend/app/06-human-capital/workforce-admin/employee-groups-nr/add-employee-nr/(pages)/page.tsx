...
export default function AddIntervalPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (ok) {
            router.push("/06-human-capital/workforce-admin/employee-groups-nr/view-employee-nr");
        }
    };
            ...
            <div className="sales-card compact">
                ...
                <form onSubmit={handleSubmit} style={{ maxWidth: "600px", marginTop: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem" }}>
                        ...
                        <Button variant="secondary" type="button" onClick={() => router.push("/06-human-capital/workforce-admin/employee-groups-nr/view-employee-nr")}>
                            إلغاء
                        </Button>
                    </div>
                </form>
