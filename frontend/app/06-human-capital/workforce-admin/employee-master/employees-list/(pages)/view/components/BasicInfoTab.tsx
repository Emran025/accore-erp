                    ...
                    actions={
                        <div className="flex gap-2">
                            {canAccess("employees", "edit") && (
                                <Button variant="primary" icon="edit" onClick={() => router.push(`/06-human-capital/workforce-admin/employee-master/employees-list/edit/${employee.id}`)}> تعديل البيانات</Button>
                            )}
                        </div>
                    }
                />
