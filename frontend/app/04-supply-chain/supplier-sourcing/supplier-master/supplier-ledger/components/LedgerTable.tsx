...
export function LedgerTable({
    ...
    const tabs = [
        ...
        { key: "invoice", label: catalogMessage("common.general.purchaseInvoices"), icon: "file-text" },
        { key: "payment", label: catalogMessage("supplyChain.ledgertable.paymentVouchers"), icon: "receipt" },
    ...
    const getTypeName = (type: string) => {
        const types: Record<string, string> = {
            invoice: catalogMessage("common.general.purchaseInvoice"),
            payment: catalogMessage("supplyChain.ledgertable.disbursementVoucher"),
    ...
    const columns: InvoiceTableColumn<LedgerTransaction>[] = [
        ...
        {
            key: "debit",
            header: catalogMessage("common.general.debtorYou"),
            dataLabel: catalogMessage("common.general.debtorYou"),
            render: (item) => (
        ...
        {
            key: "credit",
            header: catalogMessage("common.general.creditorYou"),
            dataLabel: catalogMessage("common.general.creditorYou"),
            render: (item) => (
