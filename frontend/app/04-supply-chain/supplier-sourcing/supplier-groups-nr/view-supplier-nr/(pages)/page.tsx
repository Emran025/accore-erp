...
import { DomainFullnessPanel, ExpansionLogsPanel, NrLoading, NrObjectHeader, NrSetupPrompt, useNumberRange } from "@/components/number-range";
...
export default function ViewNumberRangeIntervalsPage() {
    ...
    const { objectData, isLoading, createObject, saveInterval, deleteInterval, expandInterval } = useNumberRange({ objectType: "ap_suppliers" });
        ...
        return (
            <MainLayout>
                <div className="page-header">
                    <h2>عرض نطاقات أرقام الموردين</h2>
                </div>
        ...
        <MainLayout>
            ...
            <div className="sales-card compact">
                <PageSubHeader
                    ...
                    titleIcon="hash"
                    actions={
                        <Button variant="primary" icon="plus" onClick={() => router.push("/04-supply-chain/supplier-sourcing/supplier-groups-nr/add-supplier-nr")}>
                            إضافة نطاق جديد
                        </Button>
                    }
                />
