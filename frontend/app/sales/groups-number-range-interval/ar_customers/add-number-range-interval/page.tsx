...
export default function AddIntervalPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (ok) {
            router.push("/ar_customers/groups-number-range-interval/ar_customers/view-number-range-intervals");
        }
    };
            ...
            <div className="sales-card compact">
                ...
                <form onSubmit={handleSubmit} style={{ maxWidth: "600px", marginTop: "1rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "1rem" }}>
                        ...
                        <Button variant="secondary" type="button" onClick={() => router.push("/ar_customers/groups-number-range-interval/ar_customers/view-number-range-intervals")}>
                            إلغاء
                        </Button>
                    </div>
                </form>
