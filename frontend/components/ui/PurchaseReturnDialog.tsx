...
export function PurchaseReturnDialog({
    ...
    const calculations = useMemo(() => {
        ...
        selectedItems.forEach(item => {
            ...
            // Proportional VAT
            const proportion = (invoice.subtotal || 0) > 0 ? itemSubtotal / (invoice.subtotal || 0) : 0;
            totalVat += (invoice.vat_amount || 0) * proportion;
        });
    ...
    return (
        <Dialog
            isOpen={isOpen}
            onClose={handleClose}
            title={step === "review" ? "مرتجع مشتريات" : "تأكيد المرتجع"}
            maxWidth="800px"
            footer={
                            ...
                            <div className="confirm-notice animate-fade-in">
                                <div className="warning-content">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li>إنشاء قيد مرتجع مشتريات بالقيمة المذكورة.</li>
                                            <li>تحديث رصيد المورد (إن وجد) وخصم الكميات من المخزن.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
