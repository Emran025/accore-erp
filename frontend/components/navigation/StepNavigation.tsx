...
export function StepNavigation({
    ...
    onCancel,
    onSave,
    nextLabel = catalogMessage("components.stepnavigation.nextStep"),
    previousLabel = catalogMessage("common.general.previous"),
    cancelLabel = catalogMessage("common.general.cancel"),
    saveLabel = catalogMessage("components.stepnavigation.saveComplete"),
