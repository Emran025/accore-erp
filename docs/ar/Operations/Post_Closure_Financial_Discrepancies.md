...
- تُعامَل Fiscal Periods المُقفَلة كسجلات تاريخية دائمة. لا توجد أي آلية في ACCSYSTEM ERP تسمح بتعديل أو حذف قيود في فترة مُقفَلة، مما يلبّي متطلبات IFRS وGAAP لقابلية إعادة إنتاج البيانات المالية.
