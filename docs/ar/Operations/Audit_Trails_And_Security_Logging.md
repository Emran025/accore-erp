...
يُحدّد هذا الدليل الإجراءات التشغيلية للحفاظ على Audit Trail (سجل التدقيق) ومراجعته والتحقق من صحته، وكذلك آليات التسجيل الأمني في ACCSYSTEM ERP. يُوجَّه إلى مهندسي الأمان ومسؤولي الامتثال والمدققين المسؤولين عن التحقق من قابلية تتبع نشاط النظام والحوكمة السليمة لبيانات اعتماد الوصول للمستهلكين الخاضعين للتنظيم. يُعرَّف Audit Trail في ACCSYSTEM بأنه سجل زمني غير قابل للتغيير لجميع أحداث النظام لأغراض الامتثال التنظيمي.
